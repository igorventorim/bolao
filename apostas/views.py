...
def calcular(request):
    try:
            ...
            for aposta in apostas:
                ...
                if jogo1_time != '' and jogo2_time != '':
                    if jogo1_time > jogo2_time:
                        ...
                        if aposta1_time == aposta2_time:
                            pts += 3
                    if aposta1_time == jogo1_time and aposta2_time == jogo2_time:
                        pts += 2
                    if aposta1_time + aposta2_time == jogo1_time + jogo2_time:
                        pts += 1
                    usuario.ranking += pts
                    usuario.save()
                aposta.pontos = pts
        ...
        pass
    return redirect('/admin-calcular/')

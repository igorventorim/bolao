...
class Jogo(models.Model):
    id = models.AutoField(primary_key=True, unique=True)
    primeirotime = models.ForeignKey(
        Time, related_name="primeirotime", null=True, on_delete=models.DO_NOTHING)
    resultadoprimeirotime = models.IntegerField(
        "resultadoprimeirotime", null=True, blank=True)
    segundotime = models.ForeignKey(
        Time, related_name="segundotime", null=True, on_delete=models.DO_NOTHING)
    resultadosegundotime = models.IntegerField(
        "resultadosegundotime", null=True, blank=True)
    data = models.DateField("data", auto_now_add=True)
    calculado = models.BooleanField("calculado")
    campeonato = models.ForeignKey(
        Campeonato, null=True, on_delete=models.DO_NOTHING)
    datajogo = models.DateField("datajogo", null=True)
    rodada = models.IntegerField("rodada", null=True, blank=True)
    horajogo = models.TimeField("horajogo", null=True)
